...
class _AppointmentBookingFlowState extends State<AppointmentBookingFlow> with SingleTickerProviderStateMixin {
  ...
  void _processPayment() async {
    ...
    try {
      // Collect appointment details from actual selected data
      Map<String, dynamic> appointmentDetails = {
        ...
        'fee': widget.preSelectedDoctor != null ? widget.preSelectedDoctor!['fee'] : _doctorData['fee'] ?? 'Rs. 2000',
      ...
      if (_auth.currentUser != null) {
        try {
          ...
          await _firestore.collection('appointments').add(appointmentDetails);
          debugPrint('Appointment saved to Firestore');
        } catch (e) {
          debugPrint('Error saving appointment to Firestore: $e');
        }
      }
